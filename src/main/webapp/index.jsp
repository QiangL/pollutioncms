...
<div id="topmenu" class="l-topmenu">
    ...
    <div class="l-topmenu-welcome">
        ...
        <a href="http://www.ligerui.com/pay.html" class="l-link2" target="_blank">设置</a> 
                <span class="space">|</span>
        <a href="http://www.ligerui.com/server.html" class="l-link2" target="_blank">帮助</a> 
		 <span class="space">|</span>
        <a href="http://www.ligerui.com/server.html" class="l-link2" target="_blank">注销</a> 
    </div> 
</div>
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; ">
    ...
    <div  style="height:32px; line-height:32px; text-align:center;">
            Copyright © 2017 http://ssdut.dlut.edu.cn/
    </div>
